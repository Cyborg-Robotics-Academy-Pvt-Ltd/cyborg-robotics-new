  ...
  if (payment.paymentFlow === "competition") {
    ...
    if (!existingCompetitionSnapshot.empty) {
      ...
      await updateDoc(doc(db, "competitionRegistrations", existingId), {
        ...
        emailAddress: competitionDraft.emailAddress ?? "",
    ...
    await updateDoc(paymentRef, {
      ...
      parentEmail: competitionDraft.emailAddress ?? "",
      primaryParentEmail: competitionDraft.emailAddress ?? "",
      studentEmail: competitionDraft.emailAddress ?? "",
