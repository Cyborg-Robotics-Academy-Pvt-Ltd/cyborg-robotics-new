 ...
 java: withLevels({
  ...
  arduino: withLevels({
    "1": [
      ...
      "LED blink circuit",
      "Digital input with button",
      "Serial monitor practice",
...
"3d printing": withLevels({
  "1": [
    ...
    "Hands-on with Anycubic Kobra 2 Neo 3D Printer",
    "Introduction to 3D Design with Tinkercad",
    "Advanced Tinkercad Tools and Creative Design",
    "Designing Functional Objects in Tinkercad",
    "Designing a Functional Object",
    "Understanding 3D Slicers",
    "Troubleshooting and Optimizing 3D Prints",
    "Designing a Phone Stand",
    "Supports and Overhangs in 3D Printing",
    "Creative House Design Using Tinkercad — Part 1",
    "Creative House Design Using Tinkercad — Part 2",
    "Hinged Box Design: Parametric and Tolerance Concepts",
    "Testing and Troubleshooting Hinged Box",
    "Challenge Design — Part 1",
    "Challenge Design — Part 2",
  ],
  "2": [
    "Advanced 3D Printing Techniques",
    "Introduction to Fusion 360",
    "Parametric Design and Constraints",
    "Loft and Fillet Tools for Complex Shapes",
    "Precision in Design",
    "Getting Started with Blender",
    "Text and Engraving in Blender",
    "Modifying STL Files in Fusion 360",
    "Engineering Design Concepts",
    "Tolerance Testing",
    "Functional Home Tools",
    "Fusion 360 Joint and Assembly",
    "Preparing Large Models",
    "Final Project Planning",
    "Final Project Designing and Completion",
    "Final Project Showcase and Reflection",
  ],
  "3": [
    "Advanced 3D Printing Techniques",                   // S1
    "Designing for Strength",                            // S2
    "Modular Design Techniques",                         // S3
    "Snap-Fit and Hinged Models",                        // S4
    "Multi-Part Assembly",                               // S5
    "Architectural Modelling",                           // S6
    "Threaded Parts and Screws",                         // S7
    "Everyday Use Jigs and Fixtures",                    // S8
    "Medical and Engineering Use Cases",                 // S9
    "Robotics and Automation",                           // S10
    "Gears and Motion Transfer",                         // S11
    "Electronic Enclosure Design",                       // S12
    "Final Project Planning",                            // S13
    "Prototyping and Iterations",                        // S14
    "Print Troubleshooting and Fixes",                   // S15
    "Showcase and Feedback",                             // S16
  ],
}),
