...
export const courseData: Record<string, CourseData> = {
  ...
  "mini-electronics": {
    ...
    imagePath: "/assets/classroom-course/mini-electronics.png",
    ...
    courseOverview: "Mini Electronics is a course that covers the fundamentals of electronics and programming. Students will learn to build and design electronic circuits, program microcontrollers and sensors, and apply electronics concepts to solve everyday problems. The course includes hands-on projects and实践活动 to reinforce learning.",
  },
  "spike-essential": {
    id: "spikeEssential",
  ...
  "spike-prime-python": {
    ...
    mode: "Offline",
    duration: "16 CLASSES (x4 LEVELS) (1 HOUR PER CLASS)",
    syllabusPath: "/assets/pdf/SPIKE_PRIME_PYTHON.pdf",
    syllabusFileName: "SPIKE_PRIME_PYTHON.pdf",
    ...
    keyFeatures: [
      {
        ...
        description: "Build complex robots with LEGO SPIKE Prime components",
        iconName: "Bot",
      },
      {
        title: "Python Integration",
        description: "Program robots using Python for advanced functionality",
        iconName: "Code",
      },
      {
        title: "Sensor Programming",
        description: "Work with advanced sensors and data processing",
        iconName: "Zap",
      },
      {
        title: "Automation Projects",
        description: "Create intelligent automated systems and solutions",
        iconName: "Settings",
      },
    ],
    courseOverview: "Our SPIKE PRIME + Python course combines the power of LEGO Education SPIKE Prime robotics with Python programming to create advanced automated systems. Students learn to build complex robots using SPIKE Prime components and program them using Python for sophisticated functionality. The course covers sensor integration, data processing, automation logic, and real-world problem solving. Students will work on projects that demonstrate the integration of physical robotics with advanced programming concepts, preparing them for competitive robotics and engineering challenges.",
  },
  "printing3d": {
    id: "printing3d",
    title: "3D PRINTING",
