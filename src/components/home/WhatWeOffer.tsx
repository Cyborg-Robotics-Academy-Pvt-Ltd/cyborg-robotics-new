            ...
            {whatWeOfferItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Corner accents */}
                  <div
                    className={`absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-${item.accentColor}-300/50 rounded-br-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  ></div>
                  <div
                    className={`absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-${item.accentColor}-300/50 rounded-tl-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  ></div>
                  <div
                    className={`absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-${item.accentColor}-300/50 rounded-tr-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  ></div>
                  <div
                    className={`absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-${item.accentColor}-300/50 rounded-bl-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  ></div>
                </motion.div>
              );
            })}
