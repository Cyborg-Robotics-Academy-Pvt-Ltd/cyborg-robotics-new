...
const getLevelColor = React.memo((level: string) => {
  switch (level.toLowerCase()) {
    case "1":
    case "beginner":
      return "bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 shadow-green-100";
    case "2":
    case "intermediate":
      return "bg-gradient-to-r from-blue-50 to-cyan-50 text-blue-700 shadow-blue-100";
    case "3":
    case "advanced":
      return "bg-gradient-to-r from-purple-50 to-violet-50 text-purple-700 shadow-purple-100";
    case "4":
    case "expert":
      return "bg-gradient-to-r from-orange-50 to-amber-50 text-orange-700 shadow-orange-100";
    default:
      return "bg-gradient-to-r from-gray-50 to-slate-50 text-gray-700 shadow-gray-100";
  }
});
      ...
      <div className="group relative bg-gradient-to-br from-white via-gray-50/50 to-white rounded-3xl p-6 hover:bg-gradient-to-br hover:from-white hover:via-red-50/30 hover:to-white hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-500 hover:-translate-y-2 block cursor-pointer overflow-hidden backdrop-blur-sm">
        ...
        <div className="relative z-10 mb-6 mt-8">
          ...
          <div className="flex items-center mb-4">
            <div
              className={`inline-flex items-center px-4 py-2 rounded-full text-xs font-medium shadow-sm ${getLevelColor(course.level)}`}
            >
        ...
        <div className="relative z-10 bg-gradient-to-r from-gray-50/80 to-white/80 rounded-2xl p-4 group-hover:bg-gradient-to-r group-hover:from-red-50/50 group-hover:to-white/80 transition-all duration-300 backdrop-blur-sm">
          <div className="flex items-center space-x-2 mb-3">
            ...
            {userChecked && isAdmin && editingIndex !== index && (
              <button
                className="ml-2 px-3 py-1 text-xs bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 rounded-lg hover:from-yellow-200 hover:to-amber-200 transition-all duration-200 shadow-sm"
                onClick={(e) => {
                  e.preventDefault();
          ...
          {userChecked && isAdmin && editingIndex === index ? (
            <div className="flex items-center space-x-2">
              ...
              />
              <button
                className="px-3 py-1 text-xs bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 rounded-lg hover:from-green-200 hover:to-emerald-200 transition-all duration-200 shadow-sm"
                onClick={(e) => {
                  e.preventDefault();
                  onSave(index);
                }}
              ...
              <button
                className="px-3 py-1 text-xs bg-gradient-to-r from-gray-100 to-slate-100 text-gray-800 rounded-lg hover:from-gray-200 hover:to-slate-200 transition-all duration-200 shadow-sm"
                onClick={(e) => {
                  e.preventDefault();
                  onCancel();
                }}
