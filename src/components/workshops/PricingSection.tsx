    ...
    >
      <div className="mx-auto max-w-[1200px]">
        <motion.div variants={fadeUpVariants} className="mb-10 text-center">
          ...
          <h2 className="bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-4xl font-semibold text-transparent">
            ...
            return (
              <motion.div
                ...
                className={`overflow-hidden rounded-2xl border transition-all duration-300 ${
                  isActive
                    ? "border-2 border-[#8D0F11] bg-white shadow-[0_18px_56px_rgba(141,15,17,0.18)] lg:-translate-y-1"
                    : "border-[rgba(0,0,0,0.08)] bg-[#fcfcfc] shadow-[0_2px_16px_rgba(0,0,0,0.04)]"
                }`}
              >
                <div
                  className={`relative overflow-hidden p-5 ${
                    isActive
                      ? "border-b border-[rgba(141,15,17,0.12)] bg-white"
                      : "bg-gradient-to-r from-red-700 to-red-900"
                  }`}
                >
                  <div
                    className={`absolute -right-8 -top-8 h-[120px] w-[120px] rounded-full blur-[24px] ${
                      isActive
                        ? "bg-[rgba(141,15,17,0.08)]"
                        : "bg-[rgba(199,62,29,0.2)]"
                    }`}
                  />
                  <div className="relative z-10">
                    {isActive && (
                      <span className="mb-3 inline-flex rounded-full bg-[rgba(141,15,17,0.08)] px-3 py-1 text-[12px] font-semibold text-[#8D0F11]">
                        Selected Center
                      </span>
                    )}
                    <div
                      className={`text-[17px] font-semibold ${
                        isActive ? "text-[#8D0F11]" : "text-white"
                      }`}
                    >
                      {location.name}
                    </div>
                    <div
                      className={`mt-1 text-[11px] font-normal ${
                        isActive ? "text-[#555]" : "text-white/80"
                      }`}
                    >
                ...
                <div className="bg-white p-5">
                  ...
                  >
                    ...
                    <div className="flex items-baseline justify-center gap-2">
                      ...
                      <span className="bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-2xl font-bold text-transparent">
                        ₹{startingPrice.toLocaleString("en-IN")}
                      </span>
                    </div>
                    <p className="mt-1 text-[12px] font-normal text-[#555]">
                  ...
                  <button
                    ...
                    className={`w-full cursor-pointer rounded-xl py-2.5 text-[13px] font-semibold transition-all duration-200 ${
                      isActive
                        ? "border border-[#8D0F11] bg-gradient-to-br from-[#8D0F11] to-[#B92423] text-white shadow-[0_6px_20px_rgba(141,15,17,0.3)] hover:-translate-y-0.5"
                        : "border border-[rgba(141,15,17,0.16)] bg-white text-[#555] hover:bg-[rgba(141,15,17,0.06)] hover:text-[#8D0F11]"
                    }`}
                  >
