...
export default function FoundersSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full mx-auto relative overflow-hidden bg-white sm:py-4"
    >
      {/* Header */}
      <motion.div
        initial={{ opacity: 0 }}
      ...
      {/* Founders Grid */}
      <div className="grid grid-cols-1 lg:max-w-[850px] xl:grid-cols-2 2xl:grid-cols-2 gap-6 sm:gap-8 px-2 sm:px-0 xl:max-w-[1450px] mx-2 md:mx-10 mb-4">
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-3 mb-3">
                        <motion.div
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-[#b92423] via-[#9d2723] to-[#7f2823] rounded-full shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105`}
                        >
                          {isFounder ? (
      ...
      {/* Floating background animation (optional aesthetic) */}
      <style jsx>{`
        @keyframes blob {
          0%,
          100% {
