...
const RoboticsButton: React.FC<RoboticsButtonProps> = ({
  ...
  const baseClasses =
    "relative inline-flex items-center justify-center font-medium transition-all duration-500 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden group";
  ...
  const variantClasses = {
    primary:
      "bg-gradient-to-r from-red-700 to-red-800 text-white border border-red-600 hover:from-red-700 hover:to-red-800 focus:ring-red-500",
    secondary:
