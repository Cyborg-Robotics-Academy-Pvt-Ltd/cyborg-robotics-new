  ...
  return (
    ...
    >
      ...
      >
        {items.map((item) => (
          <li
            className="w-[280px] max-w-full relative rounded-[2rem] border border-white/30 h-auto flex-shrink-0 md:w-[280px] md:mx-1 bg-white/30 backdrop-blur-lg duration-300 hover:scale-105 shadow-md"
            key={item.title}
          >
            <blockquote>
              <div
