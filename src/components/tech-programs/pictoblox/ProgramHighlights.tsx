...
const PictobloxProgramHighlights = () => {
  ...
  const courseHighlights = [
    "Build a real Maze Game in one session",
    "Live online coding workshop via Zoom",
    "Hands-on block-based coding with PictoBlox",
    "Limited seats for interactive mentoring",
    "Take home a working game project",
...
export default PictobloxProgramHighlights;
