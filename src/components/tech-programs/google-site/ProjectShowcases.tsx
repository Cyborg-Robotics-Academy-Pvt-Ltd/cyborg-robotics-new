...
const GoogleSiteProjectShowcases = () => {
  const fadeInUp = {
  ...
  const studentJourney = [
    {
      ...
      description:
        "Decide what to showcase — projects, achievements, and certificates.",
      icon: Lightbulb,
      color: "text-[#A81B1E]",
      bg: "bg-[#A81B1E]/10",
    },
    {
      title: "Set Up Google Sites",
      description:
        "Create your site, choose a layout, and set up the About Me page.",
      icon: LayoutTemplate,
      color: "text-[#0855AB]",
      bg: "bg-[#0855AB]/10",
    },
    {
      title: "Add Content",
      description:
        "Add projects, images, achievements, and format sections professionally.",
      icon: ImagePlus,
      color: "text-[#A81B1E]",
      bg: "bg-[#A81B1E]/10",
    },
    {
      ...
      description:
        "Go live — publish the portfolio and get a shareable website link.",
      icon: Globe,
      color: "text-[#0855AB]",
      bg: "bg-[#0855AB]/10",
    },
    {
      title: "Share & Grow",
      description:
        "Share the live portfolio and learn how to update it anytime.",
      icon: Share2,
      color: "text-[#A81B1E]",
      bg: "bg-[#A81B1E]/10",
    },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          <motion.div className="text-center" variants={fadeInUp}>
            <div className="inline-flex items-center gap-2 rounded-full bg-[#062341]/5 px-4 py-1.5 text-sm font-semibold text-[#062341] mb-4">
              ...
              How students go from blank page to live website
            </div>
            <motion.h2
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Students plan, build, and publish their own portfolio website —
              all in a single 2-hour live session.
            </motion.p>
          </motion.div>
...
export default GoogleSiteProjectShowcases;
