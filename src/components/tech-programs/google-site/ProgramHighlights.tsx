...
const GoogleSiteProgramHighlights = () => {
  ...
  const courseHighlights = [
    "Build a real live portfolio website",
    "Learn Google Sites from scratch",
    "Limited seats for interactive mentoring",
    "Hands-on digital skills workshop",
    "Students leave with a shareable website link",
    "Certificate of completion",
  ];

  const interests = [
    "Showcasing projects and achievements",
    "Digital tools and website creation",
    "Building a personal digital identity",
    "Technology and STEM learning",
    "Beginner-friendly web creation",
  ];
  ...
  const cards = [
    ...
    },
    {
      ...
      items: interests,
      extra: { badge: "Age: 10–16 yrs", note: "No coding knowledge required." },
    },
    {
      id: "skills",
      icon: Rocket,
...
export default GoogleSiteProgramHighlights;
