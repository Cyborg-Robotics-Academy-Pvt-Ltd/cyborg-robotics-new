...
const DroneExperience = () => {
  const modules = [
    {
      ...
      description:
        "Introduction to drone technology and how aerial robotics are used across industries.",
      highlight: "#A81B1E",
    },
    {
      icon: Wind,
      number: "02",
      title: "Quadcopter Design & Aerodynamics",
      description:
        "Understanding quadcopter structure, basics of aerodynamics, and how drones stay airborne.",
      highlight: "#062341",
    },
    {
      icon: Wrench,
      ...
      description:
        "Learn about motors, propellers, flight controllers and hands-on drone assembly.",
      highlight: "#0855AB",
    },
    {
      icon: Shield,
      ...
      description:
        "Practice responsible flying with essential safety rules and protocols.",
      highlight: "#A81B1E",
    },
    {
      icon: Plane,
      number: "05",
      title: "Flying Practice & Challenges",
      description:
        "Real drone flying sessions with obstacle challenges to test your skills.",
      highlight: "#062341",
    },
  ];
  ...
  return (
    <div>
      ...
      <motion.section
        className="learn-section relative py-4 md:pt-24 overflow-hidden bg-white"
        initial={{ opacity: 0 }}
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-slate-400 text-sm md:text-base max-w-xs leading-relaxed font-light md:text-right">
              A hands-on curriculum that takes complete beginners from drone
              basics to real flying challenges.
            </p>
          </motion.div>
