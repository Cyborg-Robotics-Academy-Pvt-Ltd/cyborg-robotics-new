...
const DroneWhyLearnSection = () => {
  const [hoveredIndex, setHoveredIndex] = useState<number | null>(null);

  const whyLearn = [
    {
      text: "Understand how drones fly",
      subtext:
        "Explore motors, propellers, and flight controllers — the real science behind aerial robotics",
      icon: Wind,
      accent: "#0855AB",
      category: "Skills",
    },
    {
      text: "Learn drone components & assembly",
      subtext: "Hands-on quadcopter design and assembly — not just theory",
      icon: Wrench,
      accent: "#A81B1E",
      category: "Skills",
    },
    {
      text: "Master basics of aerodynamics",
      subtext:
        "Understand the physics that keep drones — and aircraft — in the air",
      icon: Cpu,
      accent: "#0855AB",
      category: "Skills",
    },
    {
      text: "Practice drone flight safety",
      subtext:
        "Learn responsible flying — rules, risk awareness, and safe operation",
      icon: Shield,
      accent: "#A81B1E",
      category: "Experience",
    },
    {
      text: "Real drone flying sessions",
      subtext:
        "Get behind the controls — obstacle challenges, guided flying practice",
      icon: FlaskConical,
      accent: "#0855AB",
      category: "Experience",
    },
    {
      text: "Develop engineering curiosity & logical thinking",
      subtext:
        "Build problem-solving skills that transfer to robotics, aviation, and beyond",
      icon: Brain,
      accent: "#A81B1E",
      category: "Experience",
    },
  ...
  const tags = ["Hands-on Flying", "Real Drone Tech", "STEM Focused"];
        ...
        <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <h2 className="offer-heading text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-[#062341] mb-4 leading-[1.1] tracking-tight">
              Why Learn <span className="gradient-text">Drone Building</span>
              <br />
              <span className="gradient-text">&amp; Flying?</span>
            </h2>

            <p className="text-slate-500 text-base md:text-lg leading-relaxed font-light mt-4 max-w-xl">
              Drones are transforming filmmaking, agriculture, delivery, and
              rescue operations. In this program, students don't just watch —
              they{" "}
              <span className="text-[#062341] font-medium">
                build, fly, and experience
              </span>{" "}
              real aerial robotics firsthand.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-start">
            ...
            >
              ...
              <Image
                src="/assets/workshops/drone/image.png"
                alt="Drone course"
                width={500}
                height={700}
              ...
              <div className="absolute inset-x-0 bottom-0 z-20 bg-gradient-to-t from-[#062341]/95 via-[#062341]/60 to-transparent p-5 md:p-6">
                ...
                <p className="offer-heading text-white text-sm md:text-base font-semibold mb-3 leading-snug">
                  From ground assembly to first flight.
                </p>
            ...
            <div>
              ...
              >
                ...
                <p className="text-slate-400 text-xs font-light leading-snug">
                  No prior experience needed &middot; Age 10–16
                  <br />
...
export default DroneWhyLearnSection;
