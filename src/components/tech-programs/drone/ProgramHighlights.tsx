...
const DroneProgramHighlights = () => {
  ...
  const courseHighlights = [
    "Hands-on drone technology learning",
    "Real drone flying practice",
    "Learn about aerial robotics",
    "Mentor-guided practical sessions",
    "STEM learning through real technology",
  ...
  const cards = [
    ...
    },
    {
      ...
      items: interests,
      extra: { badge: "Age: 10–16 yrs", note: "No prior experience required." },
    },
    {
      id: "skills",
      icon: Rocket,
...
export default DroneProgramHighlights;
