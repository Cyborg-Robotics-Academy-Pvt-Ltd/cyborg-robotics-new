  ...
  export const AndroidCurriculum = [
    {
      ...
      subtitle: [
        "Intro to Android & Java: Setup, basic Java concepts, activity lifecycleand fragments.",
  ...
  export const AppDevelopmentData = [
    {
      ...
      subtitle: [
        "Explore colors, soundsand Text-to-Speech features.",
        "Learn drawing, input handlingand sensors.",
        "Build simple games using timers, physicsand animation.",
        "Work with UI design, data storageand media integration.",
    ...
    },
    {
      ...
      subtitle: [
        "Create games with collision detection, controlsand scoring.",
        "Explore app branding, GPSand Bluetooth.",
        "Learn advanced layouts, media handlingand quizzes.",
        "Fetch data from APIs, use notificationsand build a final project.",
      ],
    },
    {
      id: "3",
      ...
      subtitle: [
        "Build apps with sound, GPS tracking, pollsand trivia games.",
        "Develop memory, socialand shooter games.",
        "Work on user accounts, data visualizationand responsive design.",
    ...
    },
    {
      ...
      subtitle: [
        "Create racing, image generationand attendance apps.",
        "Use weather APIs, monetize appsand deploy them.",
        "Complete a capstone project and reflect on future opportunities.",
      ],
    },
  ];

  export const AppLabCurriculum = [
    {
      id: "1",
  ...
  export const ArtificialIntelligenceCurriculum = [
    ...
    },
    {
      ...
      subtitle: [
        ...
        "Key metrics: accuracy, precision, recalland F1-score.",
    ...
    },
    {
      ...
      subtitle: [
        ...
        "Discussion on fairness, transparencyand bias in AI systems.",
...
export const SpikeEssentialCurriculum = [
  ...
  export   const WebDesignCurriculum = [
    {
      ...
      subtitle: [
        ...
        "HTML Basics: Tags, elementsand attributes.",
    ...
    },
    {
      ...
      subtitle: [
        "CSS Layout Techniques: Margins, paddingsand borders.",
    ...
    },
    {
      ...
      subtitle: [
        "JavaScript Basics: Variables, data typesand functions.",
 ...
 export const ElectronicsCurriculumData = [
  {
    id: "1",
    ...
    subtitle: [
      ...
      "Logic Gates – Introduction to AND, OR, NOT and their applications.",
      "Integrated Circuits – Understand ICs and their role in electronics.",
      "Seven Segment Display – Learn how numbers are displayed using 7-segment modules.",
      "Automated Sharpener – Build a small automation project using switches and motors.",
      "Automated Street Light – Create a light sensor–based auto street light system.",
      "Motor Boat – Construct a working model using motors and basic circuit design.",
    ],
  },
  {
    id: "2",
    title: "Level 2: Intermediate Electronics",
    subtitle: [
      "Volume & brightness control using potentiometer – Learn variable resistance for real-world control.",
      "LDR (Light Dependent Resistor) – Create light-sensitive circuits.",
      "Capacitor and Microphone – Explore sound-based input and energy storage.",
      "Transistor (NPN & PNP) – Use transistors as switches and amplifiers.",
      "Mail Notifying System – Build a notification circuit using sensors.",
      "Optical Transmitter & Receiver – Learn wireless communication using light signals.",
      "Microphone & Voice Controlled Rays of Light – Convert sound input into visual output.",
      "Project using PeeCee – Apply electronics with a microcontroller.",
      "Amplifier using Snap Circuit – Boost audio signals using amplifier components.",
      "Eco Motion Lights – Create motion-activated lighting.",
      "Challenges – Practical problem-solving tasks.",
    ],
  },
  {
    id: "3",
    ...
    subtitle: [
      "Recording IC – Learn how to record and play audio using electronic modules.",
      "Power Amplifier – Build powerful sound-based circuits.",
      "SCR – Understand Silicon Controlled Rectifier and switching applications.",
      "EMI – Learn about electromagnetic interference and circuit protection.",
      "Transformer – Explore AC voltage conversion and safety.",
      "Laser Burglar Alarm PeeCee – Create a laser-based security system.",
      "Camera Pan Synchronization PeeCee – Control camera movement using electronics.",
      "Smart Bin – Build an auto-opening bin using sensors.",
      "Home Automation – Automate appliances using advanced circuits.",
      "Challenges – Complex projects to test understanding.",
    ],
  },
];
...
export const DroneCurriculumData = [
  {
    ...
    ageGroup: "4+ Years",
    subtitle: [
      "Day 1: Discover the Drone World",
      "Day 2: Anatomy of a Drone",
      "Day 3: Secrets of Flight",
      "Day 4: Let's Build – Part 1",
      "Day 5: Let's Build – Part 2",
      "Day 6: Mastering the Controls",
      "Day 7: Ignition and Inspection",
      "Day 8: Into the Skies",
      "Day 9: Pilot in Command",
      "Day 10: Aerial Fun Missions – Part 1",
      "Day 11: Aerial Fun Missions – Part 2",
      "Day 12: Drone Show and Awards",
    ],
  },
  {
    id: 2,
    title: "Drone Curriculum – Level 2",
    ageGroup: "6+ Years",
    subtitle: [
      "Day 1: Engineering the Flight",
      "Day 2: Building the Core",
      "Day 3: Electronic Foundations",
      "Day 4: Precision Assembly – I",
      "Day 5: Precision Assembly – II",
      "Day 6: Propulsion System Testing",
      "Day 7: Flight Controller Configuration",
      "Day 8: Flight Controller Calibration",
      "Day 9: Pre-Flight Validation",
      "Day 10: Wireless Command System",
      "Day 11: Stability Engineering",
      "Day 12: System Integration",
      "Day 13: Intelligent Flight Control",
      "Day 14: Performance Optimization",
      "Day 15: Advanced Flight Challenges",
      "Day 16: Capstone Flight Mission",
    ],
  },
  {
    id: 3,
    title: "Drone Curriculum – Level 3",
    ageGroup: "8+ Years",
    subtitle: [
      "Day 1: The Journey Begins",
      "Day 2: Inside the Machine",
      "Day 3: Building the Foundation",
      "Day 4: Shaping the Structure",
      "Day 5: Bringing It Together",
      "Day 6: Power in Motion",
      "Day 7: Taking Command",
      "Day 8: Finding Stability",
      "Day 9: System Sync",
      "Day 10: Intelligent Control",
      "Day 11: Mission Control",
      "Day 12: Fine-Tuning the System",
      "Day 13: Ready for Launch",
      "Day 14: Beyond the Build",
      "Day 15: Into the Challenge",
      "Day 16: The Final Mission",
    ],
  },
  {
    id: 4,
    title: "Drone Curriculum – Level 4",
    ageGroup: "10+ Years",
    subtitle: [
      "Day 1: Flight Systems Revisited",
      "Day 2: Flight Readiness",
      "Day 3: Precision Flight",
      "Day 4: Performance Analysis",
      "Day 5: Smart Computing Platform",
      "Day 6: Software Foundations",
      "Day 7: Environmental Awareness",
      "Day 8: Intelligent Inputs",
      "Day 9: Data Intelligence",
      "Day 10: Autonomous Logic",
      "Day 11: System Integration",
      "Day 12: Autonomous Configuration",
      "Day 13: Flight Validation",
      "Day 14: Autonomous Testing",
      "Day 15: Intelligent Missions",
      "Day 16: Autonomous Capstone",
    ],
  },
];
